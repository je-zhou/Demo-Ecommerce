  ...
  return (
    <div>
      ...
      <p className="text-gray-400 whitespace-pre-line">
        {data.description
          ? Buffer.from(data.description.data).toString("utf-8")
          : ""}
      </p>
      {/* Variants */}
      <div className="">
      ...
      <div className="pt-12 flex flex-row space-x-4 items-center">
        ...
        <Quantity
          ...
          onSubtract={() => setQuantity(quantity - 1)}
        />
        {/* Cart Button */}
        <Button
          onClick={onAddToCart}
          type="button"
          variant="default"
          className="w-64 h-12 bg-black hover:bg-black text-xl rounded text-white"
        >
          Add to cart
